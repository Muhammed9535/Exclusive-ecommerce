...
function WishListitem({ product, display }) {


    const { addItemToCart, removeItemFromCart, removeFromWishList, cartItem, url } = useContext(StoreContext);
        ...
        <div className={display ? "product-item me-4" : ""}>
            <div className="img-con p-3 position-relative">
                ...
                <IconButton className='position-absolute top-0 end-0' onClick={() => {
                    ...
                    <DeleteForeverOutlinedIcon style={{ width: "16px" }} />
                </IconButton>
                ...
                {cartItem[product.id] ?
                    ...
                    <div className="add-remove-item" style={{ height: "20px" }}>
                        ...
                        <p style={{ display: "inline", fontSize: "15px" }}>{cartItem[product
                            .id
                        ]}</p>
                        <IconButton onClick={() => {
